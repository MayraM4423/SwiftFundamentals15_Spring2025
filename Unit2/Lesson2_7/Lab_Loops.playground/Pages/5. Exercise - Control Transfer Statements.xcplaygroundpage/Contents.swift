...
for (index, letter) in alphabet.enumerated() {
    ...
    print("Every other letter will print: \(index) \(letter).")
}
...
var places: [String: String] = ["North Carolina": "Raleigh", "Ohio": "Columbus", "Colorado": "Denver"]
let home = "North Carolina"
for (state, capital) in places {
    print("The capital of \(state) is \(capital).")
    
    if state == home {
        print("I found your home! \(capital), \(state).")
    }
}
