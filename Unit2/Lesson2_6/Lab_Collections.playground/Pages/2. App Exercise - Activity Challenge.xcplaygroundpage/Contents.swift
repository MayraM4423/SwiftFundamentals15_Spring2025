 ...
 */
var walkingChallenges: [String] = ["1 Mile", "3 Miles", "5 Miles", "10 Miles"]
var runningChallenges: [String] = ["Morning Run", "Night Run", "Half-Marathon", "Full Marathon"]
...
if committedChallenges.isEmpty {
    print("The challenege you have chosen is ")
} else {
